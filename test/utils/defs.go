...
const (
	...
	// NearRTRicBaseURL is the default URL to the onos-a1t near-RT RIC REST interface
	NearRTRicBaseURL = "http://onos-a1t:9639"

	// NonRTRicBaseURL is the default URL to the mocked non-RT RIC
	NonRTRicBaseURL = "0.0.0.0:9640"

	// TestTimeout is timeout value for the test
	TestTimeout = 10 * time.Minute
	//TestInterval is the test interval value
